...
const features = [
  {
    ...
    description: "Customers pay in any token on any chain — Base, Arbitrum, BNB, Solana, or fiat. Funds settle as USDC in your treasury. KIRAPAY routes, you ignore the chain.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Programmable treasury",
    description: "Your treasury is an Ika dWallet — MPC custody split between you and the network. Spending caps, role-based co-sign, cross-chain reserves enforced by an Anchor program. Not a hot wallet. Not Fireblocks.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Encrypted compensation policy",
    description: "Salary bands, approval thresholds, and payout matrices live as ciphertexts. Encrypt's FHE program checks 'within band' on encrypted inputs. Nobody — including you — has to read the bands to approve a batch.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Shielded payroll",
    description: "30 contractors, one shielded entry on the public ledger. Each recipient gets a stealth claim link. Auditors get a scoped viewing key. Solscan sees nothing useful.",
    visual: "security",
  },
];
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            The part the incumbents
            <br />
            <span className="text-muted-foreground">can&apos;t ship.</span>
          </h2>
        </div>
